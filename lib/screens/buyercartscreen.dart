...
class _BuyerCartScreenState extends State<BuyerCartScreen> {
                          ...
                          child: Row(
                            children: [
                              CachedNetworkImage(
                                ...
                                fit: BoxFit.cover,
                                imageUrl:
                                    "${ServerConfig.SERVER}/barter_it/assets/photo/${cartList[index].itemId}_1.jpg",
  ...
  void loadcart() {
    http.post(Uri.parse("${ServerConfig.SERVER}/barter_it/php/load_cart.php"),
        body: {
  ...
  void deleteCart(int index) {
    http.post(Uri.parse("${ServerConfig.SERVER}/barter_it/php/delete_cart.php"),
        body: {
  ...
  void updateCart(int index, int newqty, double newprice) {
    http.post(Uri.parse("${ServerConfig.SERVER}/barter_it/php/update_cart.php"),
        body: {
          "cartid": cartList[index].cartId,
